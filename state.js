    ...
    base.hands = (Array.isArray(source.hands) ? source.hands : [])
      .filter(
        (hand) =>
          hand &&
          typeof hand === 'object' &&
          typeof hand.bidderId === 'string' &&
          hand.deltas &&
          typeof hand.deltas === 'object',
      )
      .map((hand, i) => ({
        ...
        made: !!hand.made,
        tricks: hand.tricks && typeof hand.tricks === 'object' ? hand.tricks : {},
        deltas: hand.deltas,
      }));
    return base;
  }
